...
<div class="alert alert-danger" role="alert" id="werror">
  <p id="merror"></p>
     ...
     <div class="form-group">    
                      <label for="idtipot">* CATEGORIA:</label>
                      <?php 
                        echo form_dropdown('idtipot', $tipotrabajador, '', 'class="form-control selectpicker" id="idtipot" required '); ?>       
                   </div> 
      </div>  
      <div class ="col-md-12">
     <div class="form-group">    
                      <label for="idtipodocut">* TIPO DOCUMENTO:</label>
                      <?php 
                        echo form_dropdown('idtipodocut', $tipodocumento, '', 'class="form-control selectpicker" id="idtipodocut" required '); ?>       
                   </div> 
      </div>  
      <div class ="col-md-12">
